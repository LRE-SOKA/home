...
{% include image.html url="./assets/images/overveiw_EARTH.jpg" style="width: 70px"%} description="本プロジェクトが目指すシステムの概略図" wrapper_style="width: 150px;" %}
{% include image.html url="./assets/images/hoteiaoi_racewaypond.jpg" style="width: 70px"%} description="エチオピアで過剰繁茂しているホテイアオイと建設したレースウェイポンド" wrapper_style="width: 150px;" %}
</div>
