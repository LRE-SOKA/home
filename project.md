...
{% include image.html url="./assets/images/overveiw_EARTH.jpg" style="width: 300px;" description="本プロジェクトが目指すシステムの概略図" %}
{% include image.html url="./assets/images/hoteiaoi_racewaypond.jpg" style="width: 300px;" description="エチオピアで過剰繁茂しているホテイアオイと建設したレースウェイポンド" %}
</div>
